...
public class SynchronizedCollectionPersist<C extends Collection<M>, M extends PersistentObject>
        extends CollectionPersist<C, M> {

    public SynchronizedCollectionPersist(final Class<C> collectionModelClass, final Class<M> collectionItemModelClass) {
